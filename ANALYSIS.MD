...
* of course, HPA without cluster autoscaler is of little use. E.g. on GKE is built-in, on other clouds I would just deploy this: https://github.com/helm/charts/tree/master/stable/cluster-autoscaler
